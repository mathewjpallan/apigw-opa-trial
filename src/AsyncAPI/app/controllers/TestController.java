...
public class TestController extends Controller {
    ...
    public Result userApi(String input) throws Exception {
        return ok ("userAPI returns: " + input);
    }

    public Result adminApi(String input) throws Exception {
        return ok ("AdminAPI returns: " + input);
    }
